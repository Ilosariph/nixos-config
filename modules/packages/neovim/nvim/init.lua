...
require('lazy').setup({
  ...
  { -- You can easily change to a different colorscheme.
    ...
    config = function()
      ...
      -- Load colorscheme from scheme.lua (generated by NixOS from dotfiles.theme.neovimScheme).
      -- Falls back to tokyonight-night if the file doesn't exist.
      local scheme_file = vim.fn.stdpath('config') .. '/scheme.lua'
      if vim.loop.fs_stat(scheme_file) then
        dofile(scheme_file)
      else
